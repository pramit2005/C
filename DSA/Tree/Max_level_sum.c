...
int Max_level_sum(Tree *root,int *level_max){
    int max_sum=0,level_sum=0,level=1;
    Tree *temp;
    Queue q={NULL,NULL};
    if(!root)
        return 0;
    ...
    while(1){
        ...
        switch(a){
            ...
            case 2:
                ...
                break;
            case 3:
                b=Max_level_sum(root,l);
                printf("\n The maximum sum is: %d of level: %d",b,*l);
                break;
            case 5:
                exit(0);
                break;
