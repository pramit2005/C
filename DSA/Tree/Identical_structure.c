...
int Identical_struct(Tree *root1,Tree *root2){
    if(root1==NULL && root2==NULL)
        return 1;
    if(root1==NULL || root2==NULL)
        return 0;
    else
        return ((root1->data==root2->data) && Identical_struct(root1->left,root2->left) && Identical_struct(root1->right,root2->right));
}
    ...
    while(1){
        ...
        switch(a){
            ...
            case 2:
                ...
                break;
            case 3:
                x=Identical_struct(root1,root2);
                if(x==1)
                    printf("\n Yes,trees are identical");
                else
                    printf("\n No,trees are not identical");
                break;
            case 5:
                exit(0);
                break;
